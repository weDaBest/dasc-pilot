...
import LazyLoadAddNewOUSDialog from "./subscription/LazyLoadAddNewOUSDialog";
...
function Main(props) {
  ...
  const [isAddNewOUSDialogOpen, setIsAddNewOUSDialogOpen] = useState(false);
  ...
  const openAddNewOUSDialog = useCallback(() => {
    setIsAddNewOUSDialogOpen(true);
  }, [setIsAddNewOUSDialogOpen]);

  const closeAddNewOUSDialog = useCallback(() => {
    setIsAddNewOUSDialogOpen(false);
  }, [setIsAddNewOUSDialogOpen]);
  ...
  const onPaymentSuccess = useCallback(() => {
    ...
    setIsAddNewOUSDialogOpen(false);
  }, [pushMessageToSnackbar, setIsAddNewOUSDialogOpen]);
  ...
  return (
    <Fragment>
      <LazyLoadAddNewOUSDialog
        open={isAddNewOUSDialogOpen}
        onClose={closeAddNewOUSDialog}
        onSuccess={onPaymentSuccess}
      />
      <NavBar
        selectedTab={selectedTab}
        messages={messages}
        openAddNewOUSDialog={openAddNewOUSDialog}
      />
